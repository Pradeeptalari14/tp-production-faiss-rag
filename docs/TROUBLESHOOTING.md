# 🔧 Troubleshooting Guide — Production-Ready RAG with FAISS
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-production-faiss-rag/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/production-faiss-rag/)
