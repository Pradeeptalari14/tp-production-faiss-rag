...
Thank you for your interest in improving the **Production-Ready RAG with FAISS** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-production-faiss-rag.git
...
Generated configurations come from the **[Production-Ready RAG with FAISS Studio](https://pradeeptalari14.github.io/portfolio/tools/production-faiss-rag/)**.
